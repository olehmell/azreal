...
export const uiMsg = {
  ...
  measurements: {
    title: 'Вибірка даних',
    desc: `Щоб отримати дані, потрібно обрати рівень агрегації, початкову та кінцеву дату та ід локації, по якій здійснити пошук. Звернуть увагу, що максимум можна отримати ${aggregationLimit} одиниць даних.`,
    info: { 
      title: 'Вимірювання',
