...
export const ADD_SENSOR_QUERY = gql`
  mutation AddSensor($mapsLink: String = "", $locationPoint: point = "", $locationId: Int!, $elevation: float8 = "", $airlyLink: String = "", $address: String = "", $sensorId: Int!, $model: String = "", $manufacturer: String = "", $timestamp: timestamp!, $documentIds: _text = "", $photoIds: _text = "", $sensorFactors: [az_sensors_SensorFactors_insert_input!]! = {}) {
    ...
    insert_az_sensors_Sensors_one(object: {sensorId: $sensorId, model: $model, manufacturer: $manufacturer, locationId: $locationId, ServiceLogs: {data: {timestamp: $timestamp, Photo: {data: {fileIds: $photoIds}}, Document: {data: {documentType: Service, fileIds: $documentIds}}, serviceKind: Planned}}, SensorFactors: {data: $sensorFactors}}, on_conflict: {constraint: Sensors_pkey, update_columns: [locationId, model, manufacturer]}) {
      sensorId
    }
