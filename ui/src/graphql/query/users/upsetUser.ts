...
export const UPSET_USER = gql`
  mutation AddUser($userRole: String = "user", $phoneNumber: String, $fullName: String, $email: String, $documentId: Int, $userId: Int, $organisationId: Int) {
...
export const useUpsetUser = (id?: number) => useMutation<UpsetUser, UpsetUserVariables>(id ? UPSET_USER : ADD_USER)
